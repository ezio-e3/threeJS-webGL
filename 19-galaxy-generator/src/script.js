...
parameters.inColor = '#ff6030'
parameters.outColor = '#1b3984'
...
const generateGalaxy = () => {
    ...
    const colorInside = new THREE.Color(parameters.inColor)
    const outsideColor = new THREE.Color(parameters.outColor)
...
gui.add(parameters, 'randomnessPow').min(1).max(10).step(0.01).onFinishChange(generateGalaxy)
